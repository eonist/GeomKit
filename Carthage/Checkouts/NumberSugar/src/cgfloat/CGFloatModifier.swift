...
public class CGFloatModifier {
    ...
    */
   public static func increment(_ number: CGFloat, _ incrementation: CGFloat) -> CGFloat {
    ...
    * - Note: The multiplication and division is a floating bug fix, optimized by looking at how many decimal points the PARAM: number has
    */
   public static func decrement(_ number: CGFloat, _ decrementation: CGFloat) -> CGFloat {
    ...
    */
   public static func toFixed(_ value: CGFloat, _ places: Int) -> CGFloat {
