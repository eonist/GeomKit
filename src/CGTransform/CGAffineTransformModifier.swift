...
public class CGAffineTransformModifier {
    ...
    */
   public static func transformWithPivot(_ transform:inout CGTransform, _ scale: CGPoint, _ rotation: CGFloat, _ offset: CGPoint, _ pivot: CGPoint, _ initRotation: CGFloat = 0) -> CGTransform {
      ...
      transform.translate(x: -pivot.x + offset.x, -pivot.y + offset.y) // globalToLocal
      return transform
   }
   /**
    * Applys a AffineTransformation on a point (This method is mostly for convenience)
    */
   public static func transformPoint(_ point: CGPoint, _ transform: CGTransform) -> CGPoint {
