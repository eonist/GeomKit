...
public func +(a: CGSize, b: CGSize) -> CGSize { return .init(a.width + b.width, a.height + b.height) }
public func -(a: CGSize, b: CGSize) -> CGSize { return .init(a.width - b.width, a.height - b.height) }
public func * (a: CGSize, b: CGSize) -> CGSize { return .init(a.w * b.w, a.h * b.h)}
...
public func * (a: CGSize, b: CGFloat) -> CGSize { return .init(a.w * b, a.h * b) }
