...
class CGRectAsserter {
    static func containsOrIntersectsLine(_ rectangle: CGRect, line:Line) -> Bool {
     ...
     */
    static func containsLine(_ rectangle: CGRect, line:Line) -> Bool {
     ...
     */
    static func intersectsLine(_ rectangle: CGRect, line:Line) -> Bool {
