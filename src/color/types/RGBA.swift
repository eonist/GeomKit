 ...
 * - Fixme: ⚠️️ its better to use values from 0 to 100 for alpha. as alpha 50 is easier to read than alpha 127.5, also keep in mind UInt can't hold fractions
 */
class RGBA {//<--- Fixme: ⚠️️ could be a struct
    var r:UInt/*0-255*/
    var g:UInt/*0-255*/
    var b:UInt/*0-255*/
