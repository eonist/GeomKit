...
public class LineAsserter {
   ...
   public static func converging(p1: CGPoint, p2: CGPoint, angle1: CGFloat, angle2: CGFloat) -> Bool {
      let p1A = CGPoint.polarPoint(radius: 100, angle: angle1).add(p: p1)
      let p1B = CGPoint.polarPoint(radius: 100, angle: angle1 - π).add(p: p1)
      let p2A = CGPoint.polarPoint(radius: 100, angle: angle2).add(p: p2)
      let p2B = CGPoint.polarPoint(radius: 100, angle: angle2 - π).add(p: p2)
