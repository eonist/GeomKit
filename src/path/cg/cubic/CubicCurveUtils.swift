...
public class CubicCurveUtils {
    ...
    */
   public static func pt(_ a1: CGPoint, _ a2: CGPoint, _ c1: CGPoint, _ c2: CGPoint, _ t: CGFloat) -> CGPoint{
    ...
    *   - p1: end point
    */
   public static func point(_ p0: CGPoint, _ c0: CGPoint, _ c1: CGPoint, _ p1: CGPoint, _ x: CGFloat)->CGPoint{
      let a: CGFloat = p0.x
      let b: CGFloat = c0.x
      let c: CGFloat = c1.x
      let d: CGFloat = p1.x
