...
public class CGShapeUtil {
    ...
    * }()
    */
    public static func drawLine( lineLayer: CAShapeLayer, line: (p1: CGPoint, p2: CGPoint), style: (stroke: Color, strokeWidth: CGFloat)) -> CAShapeLayer {
    ...
    * polyline
    */
   public static func drawPolyLine(points: [CGPoint], style: (fillColor: Color?, strokeColor: Color?, thickness: CGFloat?)?, close: Bool = false) -> CAShapeLayer {
    ...
    */
   public static func drawRect(shapeLayer:CAShapeLayer, rect: CGRect, style: (fillColor: Color?, strokeColor: Color?, thickness: CGFloat?)?) -> CAShapeLayer {
      let path: CGMutablePath  = CGMutablePath()
      path.addRect(rect)
...
//   typealias Corners = (topLeft: CGFloat,  topRight: CGFloat,  bottomLeft: CGFloat,  bottomRight: CGFloat)
    ...
    * Draws rounded rect
    */
   public static func drawRoundedRect(layer: CAShapeLayer, rect: CGRect, radius: NSRectCorner, style: Style) -> CAShapeLayer{
